...
class MySFTDataset(Dataset):
    ...
    def _read_files_and_tokenize(self):
        self.dataframe = pd.read_parquet(self.parquet_files[0])
        
        self.prompts = self.dataframe[self.prompt_key].to_list()
        self.responses = self.dataframe[self.response_key].to_list()
