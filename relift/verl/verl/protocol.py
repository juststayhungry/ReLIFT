...
class DataProto:
    ...
    def copy(self) -> 'DataProto':
        """Deep copy the DataProto object, including batch, non_tensor_batch, and meta_info."""
        new_proto = DataProto()
        new_proto.batch = self.batch.clone() if hasattr(self.batch, 'clone') else copy.deepcopy(self.batch)
        new_proto.non_tensor_batch = copy.deepcopy(self.non_tensor_batch)
        new_proto.meta_info = copy.deepcopy(self.meta_info)
        return new_proto
